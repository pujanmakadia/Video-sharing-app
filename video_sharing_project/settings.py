"""
Django settings for video_sharing_project project.
...
SECRET_KEY = 'django-insecure-y31z^vqd5ry(_u1_oka#1en^8^7un9j#qo0@u(p+2j720*giwx'
...
INSTALLED_APPS = [
    ...
    'video_post.apps.VideoPostConfig',
...
ROOT_URLCONF = 'video_sharing_project.urls'
